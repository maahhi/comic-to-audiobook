...
- For each assignment, create a short in-character reference line (3-4 sentences at most) that captures the voice and attitude of the speaker. This line will be used as guidance when cloning the voice, keep it faithful to the character’s speech but also be creative and descriptive.
  ...
  "characters": [
    {
      ...
      "reference_line": "<3-4 sentences in-character line for voice cloning>"
    },
    ...
  ],
  "narrator": {
...
Ensure the JSON is valid, includes every speaking role plus the narrator entry, and populate a thoughtful reference_line for each.
